package io.pierre.annotation.beanFactory;
...
@SupportedAnnotationTypes("com.horstmann.annotation.Property")
...
public class BeanInfoAnnotationFactory extends AbstractProcessor {
	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
		...
		for (TypeElement t : annotations) {
			...
			for (Element e : roundEnv.getElementsAnnotatedWith(t)) {
				...
				if (!found) {
					processingEnv.getMessager().printMessage(Kind.ERROR, "@Property must be applied to getXxx, SetXxx, or isXxx method", e);
	...
	private void writeBeanInfoFile(String beanClassName, Map<String, Property> props) throws IOException {
		...
		out.println("	public java.beans.PropertyDescription[] getPropertyDescriptors(){");
