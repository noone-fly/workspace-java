...
import io.pierre.rtm.RtmTokenBuilderSample;
...
public class CreateRtmTokenPanel extends JPanel {
	...
	public CreateRtmTokenPanel() {
		...
		createToken = new JButton("创建 RTM Token");
		...
		createToken.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (null == appId || appId.equals("")) {
					...
					String token = "";
					try {
						token = RtmTokenBuilderSample.generateRtmToken(appId, appCertificate, uid, expireTimestamp);
					} catch (Exception e1) {
