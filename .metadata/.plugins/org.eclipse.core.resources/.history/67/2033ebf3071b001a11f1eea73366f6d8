...
public class ValidateRtmTokenPanel extends JPanel {
	...
	public ValidateRtmTokenPanel() {
		...
		JLabel label = new JLabel("<html><font color=\"red\"><b>说明：</b>RTM token报错，验证参数<br>"
		...
		validateToken = new JButton("验证RTMToken");
		...
		validateToken.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (null == token || token.equals("")) {
					...
					String crc_uid_positive = str[1];
					String ts_positive = str[2];
					String crc_uid_negative = str[3];
